# HTML5 starter kit with Latest vendors(bundle/separate):
...
<br><br>
note: you will able to add all these vendors with one css and one js bundle file or separately to your project. you are always welcome to create pull request if you have imporvement suggestions.
